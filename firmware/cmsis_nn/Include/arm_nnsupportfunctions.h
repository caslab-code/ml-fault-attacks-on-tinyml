...
/**
  ...
  @return        q31 value
 */
static inline int32_t arm_nn_read_q15x2_ia(const int16_t **in_q15)
{
    int32_t val;
...
/**
  ...
  @return        q31 value
 */
static inline int32_t arm_nn_read_s8x4_ia(const int8_t **in_s8)
{
    int32_t val;
    memcpy(&val, *in_s8, 4);
    *in_s8 += 4;
...
/**
  ...
  @return        q31      value
 */
static inline int32_t arm_nn_read_s8x2_ia(const int8_t **in_s8)
{
    int32_t val;
    memcpy(&val, *in_s8, 2);
    *in_s8 += 2;
...
/**
  ...
  @return        s32    value
 */
static inline int32_t arm_nn_read_s16x2(const int16_t *in)
{
    int32_t val;
    memcpy(&val, in, 4);
...
/**
  ...
  @return        s32 value
 */
static inline int32_t arm_nn_read_s8x4(const int8_t *in_s8)
{
    int32_t val;
    memcpy(&val, in_s8, 4);
...
/**
  ...
  @return        s32      value
 */
static inline int32_t arm_nn_read_s8x2(const int8_t *in_s8)
{
    int32_t val;
    memcpy(&val, in_s8, 2);
 ...
 */
static inline void arm_nn_write_s8x4_ia(int8_t **in, int32_t value)
{
    memcpy(*in, &value, 4);
    *in += 4;
}
...
// */
//static inline void read_and_pad_s4(const int8_t *source, int32_t *out1, int32_t *out2)
//{
...
// *            2,          s4_x
// */
//static inline void read_and_pad_s4_uneven(const int8_t *source, int32_t *out1, int32_t *out2)
//{
...
// */
//static inline void read_and_pad_s4_ordered(const int8_t *source, int32_t *out1, int32_t *out2)
//{
//    int16_t in = arm_nn_read_s8x2(source);
//    int32_t inA = (in & 0x00FF) | ((in & 0xFF00) << 8);
...
// */
//static inline const int8_t *read_and_pad(const int8_t *source, int32_t *out1, int32_t *out2)
//{
...
// */
//static inline void read_pad_and_add_s8(const int8_t *source, int32_t *out1, int32_t *out2, const uint32_t add)
//{
...
// */
//static inline void read_and_pad_s8x2(const int8_t *source, int32_t *out)
//{
//    int16_t in = arm_nn_read_s8x2(source);
//    int32_t inA = (in & 0x00FF) | ((in & 0xFF00) << 8);
//    *out = SXTB16(inA);
...
// */
//static inline void read_pad_and_add_s8x2(const int8_t *source, int32_t *out, const uint32_t add)
//{
//    int16_t in = arm_nn_read_s8x2(source);
//    int32_t inA = (in & 0x00FF) | ((in & 0xFF00) << 8);
//    *out = SXTAB16(add, inA);
...
// */
//static inline const int8_t *read_and_pad_reordered(const int8_t *source, int32_t *out1, int32_t *out2)
//{
//    int32_t inA = arm_nn_read_s8x4_ia(&source);
//    #ifndef ARM_MATH_BIG_ENDIAN
 ...
 *
 */
static inline int32_t arm_nn_doubling_high_mult(const int32_t m1, const int32_t m2)
{
    int32_t result = 0;
 ...
 *
 */
static inline int32_t arm_nn_doubling_high_mult_no_sat(const int32_t m1, const int32_t m2)
{
    int32_t result = 0;
 ...
 *
 */
static inline int32_t arm_nn_divide_by_power_of_two(const int32_t dividend, const int32_t exponent)
{
    int32_t result = 0;
 ...
 *
 */
static inline int32_t arm_nn_requantize(const int32_t val, const int32_t multiplier, const int32_t shift)
{
 ...
 *
 */
static inline void arm_memcpy_s8(int8_t *__restrict dst, const int8_t *__restrict src, uint32_t block_size)
{
#if defined(ARM_MATH_MVEI)
 ...
 *
 */
static inline void arm_memcpy_q15(int16_t *__restrict dst, const int16_t *__restrict src, uint32_t block_size)
{
    memcpy(dst, src, block_size);
}
 ...
 *
 */
static inline int32x4_t arm_doubling_high_mult_mve(const int32x4_t m1, const int32_t m2)
{
 ...
 *
 */
static inline int32x4_t arm_divide_by_power_of_two_mve(const int32x4_t dividend, const int32_t exponent)
{
 ...
 *
 */
static inline int32x4_t arm_requantize_mve(const int32x4_t val, const int32_t multiplier, const int32_t shift)
{
    #ifdef CMSIS_NN_USE_SINGLE_ROUNDING
 ...
 *
 */
static inline int32x4_t arm_doubling_high_mult_mve_pred(const int32x4_t m1,
                                                               const int32_t m2,
 ...
 *
 */
static inline int32x4_t arm_divide_by_power_of_two_mve_pred(const int32x4_t dividend,
 ...
 *
 */
static inline int32x4_t arm_requantize_mve_pred(const int32x4_t val,
...
static inline int32x4_t arm_doubling_high_mult_mve_32x4(const int32x4_t m1, const int32x4_t m2)
{
    return vqrdmulhq_s32(m1, m2);
}

static inline int32x4_t arm_divide_by_power_of_two_mve_32x4(const int32x4_t dividend, const int32x4_t exponent)
{
...
static inline int32x4_t arm_requantize_mve_32x4(const int32x4_t val,
...
static inline int32_t arm_nn_mult_by_power_of_two(const int32_t val, const int32_t exp)
{
...
static inline int32_t arm_nn_one_over_one_plus_x_for_x_in_0_1(int32_t val)
{
 ...
 */
static inline void arm_nn_write_q15x2_ia(int16_t **dest_q15, int32_t src_q31)
{
    int32_t val = src_q31;
 ...
 */
static inline void arm_nn_write_s8x2_ia(int8_t **dst, int16_t src)
{
    memcpy(*dst, &src, 2);
    *dst += 2;
}
